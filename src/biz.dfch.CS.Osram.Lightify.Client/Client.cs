...
namespace biz.dfch.CS.Osram.Lightify.Client
{
    public partial class Client
    {
        ...
        private T Invoke<T>(HttpMethod httpMethod, string requestUriSuffix, Dictionary<string, string> headers, string body) 
            where T : BaseDto
        {
        ...
        private string Invoke(HttpMethod httpMethod, string requestUriSuffix, Dictionary<string, string> headers, string body)
        {
